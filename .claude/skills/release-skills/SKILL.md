...
**Example Commits**:
```bash
git commit -m "feat(copilot-cover-image): add watercolor and minimalist styles"
git commit -m "fix(copilot-comic): improve panel layout for long dialogues"
...
```
Commits created:
  1. feat(copilot-cover-image): add watercolor and minimalist styles
  2. fix(copilot-comic): improve panel layout for long dialogues
...
Changes grouped by skill/module:
  copilot-cover-image:
    ...
    → Commit: feat(copilot-cover-image): add watercolor and minimalist styles
    → README updates: options table

  copilot-comic:
    - fix: panel layout for long dialogues
    → Commit: fix(copilot-comic): improve panel layout for long dialogues
    → No README updates
